...
const Hero = () => {
  return (
    <section className='relative overflow-hidden bg-secondary'>
        ...
        <div className="container mx-auto px-5 py-16 md:py-24 md:px-20 relative">
            <div className="flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16">
                <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left space-y-6">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                        Find Your Dream Job at <span className='inline-block'>ZAPH</span> <span className='text-red-500'>HIRE</span>
                    </h1>
                    {/**--------------DESCRIPTION----------------- */}
                    <p className='text-lg md:text-xl leading-relaxed opacity-80 max-w-2xl'>
                        Connect with top employers and discover opportunities that match your skills.
                        Weather you are a job seeker or recruiter, we have got you covered with powerful tools
                        and seamless experience.
                    </p>
                    {/**------------STATS-------------------- */}
                    <div className="flex flex-wrap justify-center md:justify-start gap-8 py-4">
                        <div className="text-center md:text-left">
                            <p className='text-3xl fint-bold text-blue-600'>10k+</p>
                            <p className="text-sm opacity-70">Active Jobs</p>
                        </div>
                        <div className="text-center md:text-left">
                            <p className='text-3xl fint-bold text-blue-600'>5k+</p>
                            <p className="text-sm opacity-70">Companies</p>
                        </div>
                        <div className="text-center md:text-left">
                            <p className='text-3xl fint-bold text-blue-600'>50k+</p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-2">
                        <Link href={'/jobs'}>
                            ...
                            <Search size={18}/>
                            Browse Jobs <ArrowRight size={18} className='group-hover:tanslate-x-1 transition-transform'/>
                            </Button>
                        </Link>
                        <Link href={'/about'}>
